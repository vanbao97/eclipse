							...
							<div id="login-box"
								...
								<div class="widget-body">
											...
											<fieldset>
												<label class="block clearfix" style="color: red"> <%=request.getAttribute("msglogin") != null ? request.getAttribute("msglogin") : " "%>
													...
													class="block input-icon input-icon-right"> <input
														...
														placeholder="Nhập tên đăng nhập" name="membername" /> <i
												...
												<div class="clearfix">
													<a class="width-35 btn btn-sm btn-primary"
														href="https://www.facebook.com/dialog/oauth?client_id=1242670869236803&redirect_uri=https://localhost:8443/WebStudy/login-facebook">Login
														Facebook</a>
													<button type="submit"
									...
									<div class="toolbar clearfix">
										...
										<div>
											<a href="Registercontroller" class="user-signup-link"> Đăng
